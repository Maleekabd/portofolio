                ...
                <section className="h-screen relative">
                    <div className="w-full flex lg:flex lg:items-start lg:justify-start">
                        <div className="w-full flex items-center justify-center flex-col lg:items-start lg:justify-start h-screen lg:m-16 lg:mt-32 lg:w-2/5 z-50">
                            ...
                            <p className={`text-center text-[20px] lg:text-xl lg:text-start underline-offset-4 text-black ${Styles.font} lg:mt-3 m-3`}>I am a fresh graduated of electrical engineering, majoring in multimedia telecommunication </p>
